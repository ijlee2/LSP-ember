# Contributing to LSP-ember

Open source projects like `LSP-ember` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your-github-handle>/LSP-ember.git
    ```
